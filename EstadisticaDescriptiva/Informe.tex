...
\FunctionTok{plot}\NormalTok{(Datos\_Hist\_2000}\SpecialCharTok{$}\NormalTok{Fecha,decomposition\_2000}\SpecialCharTok{$}\NormalTok{x, }\AttributeTok{type=}\StringTok{"l"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(Datos\_Hist\_2000}\SpecialCharTok{$}\NormalTok{Fecha,decomposition\_2000}\SpecialCharTok{$}\NormalTok{trend, }\AttributeTok{type=}\StringTok{"l"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(Datos\_Hist\_2000}\SpecialCharTok{$}\NormalTok{Fecha,decomposition\_2000}\SpecialCharTok{$}\NormalTok{seasonal, }\AttributeTok{type=}\StringTok{"l"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(Datos\_Hist\_2000}\SpecialCharTok{$}\NormalTok{Fecha,decomposition\_2000}\SpecialCharTok{$}\NormalTok{random, }\AttributeTok{type=}\StringTok{"l"}\NormalTok{,}
